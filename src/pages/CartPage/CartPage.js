/*
    This component, CartPage, is responsible for rendering the shopping cart page.
    It displays the items in the cart, provides options to modify quantities and remove items,
    and shows an order summary including the total price, discount, and delivery charge.
*/
...
const CartPage = () => {
    // Set up Redux hooks for state management
    ...
    // Calculate and update the cart's total price when the cart state changes
    useEffect(() => {
        ...
        <div className="cart-page">
            ...
            <div className='bg-ghost-white py-5'>
                <div className='container'>
                    ...
                    {/* Display cart content or empty cart message */}
